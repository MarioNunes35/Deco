...
# -------------------------------------------
st.divider()
tab1, tab2 = st.tabs(["📑 Resultados dos picos", "💾 Exportar"])
...
st.caption("Dica: para exportar PNG em servidores sem Chrome, prefira baixar HTML e usar captura em alta resolução localmente.")
